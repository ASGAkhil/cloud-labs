                ...
                {props.content1 ?? (
                  <Fragment>
                    <span className="footer15-text2">
                      Explore our cloud-based labs for hands-on practice.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                <div className="footer15-form">
                  ...
                  <button className="thq-button-outline footer15-button">
                    <span className="thq-body-small">
                      {props.action1 ?? (
                        <Fragment>
                          <span className="footer15-text3">Subscribe</span>
                        </Fragment>
                      )}
                    </span>
                  </button>
                  ...
                  {props.content2 ?? (
                    <Fragment>
                      <span className="footer15-text7">
                        Join thousands of users improving their skills with
                        CloudLabs.
                      </span>
                    </Fragment>
                  )}
          ...
          <div className="footer15-row">
            <div className="footer15-credits2">
              <span className="thq-body-small">
                {props.privacyLink ?? (
                  <Fragment>
                    <span className="footer15-text6">Privacy Policy</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer15-text5">Terms of Use</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer15-text1">Cookie Policy</span>
                  </Fragment>
                )}
              </span>
            </div>
            ...
            {props.copyright ?? (
              <Fragment>
                <span className="footer15-text4">
                  © 2022 CloudLabs. All rights reserved.
                </span>
              </Fragment>
            )}
          </span>
