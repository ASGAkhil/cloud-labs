        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text17">Launch Lab</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text21">Profile</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-body-small thq-link">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text16">Logout</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text22">Search Labs</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-animated thq-button-outline">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text14">Help Center</span>
                  </Fragment>
                )}
              </span>
            </button>
                      ...
                      <div className="navbar8-menu-item3">
                        ...
                        <div className="navbar8-content3">
                          <span className="navbar8-page31 thq-body-large">
                            {props.page3 ?? (
                              <Fragment>
                                <span className="navbar8-text23">Profile</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item5">
                  ...
                  <div className="navbar8-content5">
                    <span className="navbar8-page12 thq-body-large">
                      {props.page1 ?? (
                        <Fragment>
                          <span className="navbar8-text15">Dashboard</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item6">
                  ...
                  <div className="navbar8-content6">
                    <span className="navbar8-page22 thq-body-large">
                      {props.page2 ?? (
                        <Fragment>
                          <span className="navbar8-text24">Launch Lab</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page1: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1565799284935-da1e43e7944e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTQxOTc1OXw&ixlib=rb-4.0.3&q=80&w=1080',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1563206767-5b18f218e8de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTQxOTc1OXw&ixlib=rb-4.0.3&q=80&w=1080',
  link2Url: 'https://www.teleporthq.io',
  link4: undefined,
  page2ImageAlt: 'Launch Lab Image',
  ...
  link3: undefined,
  page3ImageAlt: 'Profile Image',
  page1ImageAlt: 'Dashboard Image',
  logoAlt: 'CloudLabs Logo',
  action1: undefined,
  page3: undefined,
  page2: undefined,
  page4ImageAlt: 'Logout Image',
