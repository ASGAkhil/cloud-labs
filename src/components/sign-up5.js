          ...
          <div className="sign-up5-form">
            <div className="sign-up5-title-root">
              <h2 className="sign-up5-text10 thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="sign-up5-text19">Create an account</span>
                  </Fragment>
                )}
              </h2>
            ...
            <button className="sign-up5-button3 thq-button-filled">
              <span className="sign-up5-text15 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-up5-text21">Sign up with email</span>
                  </Fragment>
                )}
              </span>
            </button>
...
SignUp5.defaultProps = {
  ...
  action1: undefined,
  image1Src:
    'https://images.unsplash.com/photo-1599949104055-2d04026aee1e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NTQyMjg4MHw&ixlib=rb-4.0.3&q=80&w=1080',
}
